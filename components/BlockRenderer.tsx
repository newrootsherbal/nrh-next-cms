...
import type {
  ...
  HeadingBlockContent,
  ButtonBlockContent,
  PostsGridBlockContent,
} from "@/utils/supabase/types"; // Added PostsGridBlockContent
      ...
      {blocks.map((block) => {
        ...
        switch (block.block_type) {
            ...
            return (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: textContent.html_content || "",
                }}
              />
            );
          case "heading":
            ...
            const level =
              typeof headingContent.level === "number" &&
              headingContent.level >= 1 &&
              headingContent.level <= 6
                ? headingContent.level
                : 2;
          ...
          case "button":
            ...
            const isExternal =
              buttonContent.url?.startsWith("http") ||
              buttonContent.url?.startsWith("mailto:") ||
              buttonContent.url?.startsWith("tel:");
