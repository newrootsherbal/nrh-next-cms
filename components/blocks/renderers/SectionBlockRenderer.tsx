  ...
  switch (background.type) {
    ...
    case 'image':
      if (background.image) {
        ...
        styles.backgroundPosition = background.image.position === 'cover' || background.image.position === 'contain'
          ? 'center'
          : background.image.position;
        styles.backgroundSize = background.image.position === 'cover' ? 'cover' :
                               background.image.position === 'contain' ? 'contain' : 'auto';
        
        // Apply overlay if specified
        if (background.image.overlay && background.image.overlay.type !== 'none') {
          // This would need additional wrapper div for overlay implementation
        }
      }
      break;
